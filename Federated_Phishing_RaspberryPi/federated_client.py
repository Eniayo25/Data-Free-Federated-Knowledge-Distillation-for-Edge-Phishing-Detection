...
# =================================================================
# HARDWARE OPTIMIZATIONS FOR RESOURCE CONSTRAINED RASPBERRY PI 5
# =================================================================
# Restricting PyTorch to a single thread prevent undervoltage shutdowns.
torch.set_num_threads(1)
torch.set_num_interop_threads(1)

# Disable PyTorch memory heavy autograd profiling
...
print("[ Client ] System optimized. Loading DistilBERT student model and tokenizer...")
...
class PhishingDetectionClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        # =====================================================================
        # NON-IID DATA PARTITIONING GUARDRAIL: HIGH RISK TARGET (INDICES 10-19)
        # =====================================================================
        if lessons and len(lessons) >= 20:
            print("[Profile: High-Risk Target] Extracting aggressive phishing lures (Indices 10-19)...")
            lessons = lessons[10:20]
        elif lessons:
        ...
        if lessons and len(lessons) > 0:
            ...
            del train_dataset, train_loader, optimizer
            gc.collect()
        else:
    ...
    def evaluate(self, parameters, config):
        ...
        # clear evaluation RAM memory overhead
        gc.collect()
        
        return float(avg_loss), int(total), {"accuracy": float(accuracy)}

    def get_properties(self, config):
        return {"client_id": "raspberry_pi_5", "profile": "hybrid_spikes"}

if __name__ == "__main__":
    print("[ Client ] Connecting to central manager socket over subnet...")
