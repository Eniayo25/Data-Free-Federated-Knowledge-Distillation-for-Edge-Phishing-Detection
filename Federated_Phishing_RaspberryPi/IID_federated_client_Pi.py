...
# =================================================================
# Restrict PyTorch to a single thread to prevent undervoltage shutdowns.
...
class PhishingDetectionClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        if lessons and len(lessons) > 0:
            print(f"[ Success ] Decompressed {len(lessons)} balanced IID samples. Initializing PyTorch training...")
    ...
    def get_properties(self, config):
        return {"client_id": "raspberry_pi_5", "profile": "balanced_iid"}
