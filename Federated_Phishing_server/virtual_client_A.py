...
class PhishingDetectionClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        # =====================================================================
        # NON-IID DATA PARTITIONING GUARDRAIL: SAFE USER PROFILE (INDICES 0-9)
        # =====================================================================
        if lessons and len(lessons) >= 20:
            print(" [Profile: Safe User] Extracting benign text samples (Indices 0-9)...")
    ...
    def get_properties(self, config):
        return {"client_id": "virtual_client_a", "profile": "safe_only"}
